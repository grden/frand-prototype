        ...
        <form onSubmit={handleSubmit} className="p-4">
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl py-3 px-4 bg-gray-100 focus:bg-white focus:ring-2 focus:ring-blue-500 transition-all"
            />
          </div>
        </form>
      </div>
...
export const ChatbotButton = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="absolute bottom-6 right-6 bg-[#3182f6] text-white rounded-full w-16 h-16 flex items-center justify-center shadow-lg hover:bg-[#2d76e0] transition-colors z-40"
    >
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
